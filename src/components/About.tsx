    ...
    return (
        <section className='p-6 bg[#FFFFFF] w-full py-24 ' id='about'>
            <div className='w-full h-full   max-w-[1440px] mx-auto relative'>
                <Image src={pointingSpring} alt='pointing-spring' width={120} height={120} className='object-cover absolute -top-24 lg:-top-36 left-0 w-24 h-24 lg: ' />
                ...
                <div className='flex flex-col lg:flex-row justify-center gap-4 py-6 w-full '>
                    ...
                    <div className='flex flex-col items-center gap-6 p-12  shadow-[12px_12px_#000] hover:scale-95 border border-[#fa8000] transition-all duration-150 ease-linear max-w-md leading-relaxed w-full rounded-lg'>
