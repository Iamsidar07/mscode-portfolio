...
const Hero = () => {
    return (
        <section className='bg-[#FFF7EE] relative'>
            ...
            <Image src={spring} alt='spring' width={150} height={20} className='object-cover absolute -bottom-[13%] left-4 hidden lg:block ' />
            ...
            <div className='w-full h-[calc(100vh-4rem)]  flex flex-col items-center justify-center gap-4'>
                <Link href={'https://github.com/iamsidar07'} className='bg-gradient-radial to-[#ffffff] from-[#FFF7EE] border rounded-full px-7 py-1.5 md:py-2.5 flex items-center gap-2'>
                ...
                <p className='lg:mt-4 text-lg lg:text-2xl font-medium max-w-2xl mx-auto text-center'>Why do programmers prefer dark mode?
                    ...
                    <span className='w-44 h-12 relative ml-2'>
                        ...
                        <Image src={line} alt='line' fill className='object-contain mt-6' />
                    </span>
                </p>

                <Link href={'/#contact'} className='border px-7 py-3.5 rounded-lg tracking-wider bg-[#fa8000] text-white font-medium shadow-[4px_4px_#000] border-[#fa8000] hover:bg-[#fff] hover:text-[#fa8000] hover:rounded-full transition-all duration-200 ease-linear mt-12'>
                    Contact Me
                </Link>
