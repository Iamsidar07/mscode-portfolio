        ...
        <section className='p-6 bg[#FFFFFF] w-full py-24 '>
            ...
            <div className='w-full h-full   max-w-[1440px] mx-auto relative'>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-4 py-6 w-full '>
                    {
                        testimonials.map(({ testimonial, image, name, company, designation }, i) => <div key={i} className='flex flex-col items-center gap-6 p-12  hover:shadow-[6px_6px_#000] hover:scale-95 border border-[#fa8000] transition-all duration-150 ease-linear'>
                            <p>{testimonial}</p>
